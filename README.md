# QVAC Alibi Generator

Type what you're late for or missed and an on-device AI writes a playful, obviously-a-joke alibi, with a deterministic believability meter.
...
Then open http://localhost:29355
